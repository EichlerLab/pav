...
class Region:
    ...
    def __init__(self, chrom, pos, end, is_rev=None):
        self.chrom = chrom
        self.pos = int(pos)
        self.end = int(end)
...
def ref_kmers(region, fa_file_name, k_util):
    ...
    ref_seq = region_seq(region, fa_file_name)
